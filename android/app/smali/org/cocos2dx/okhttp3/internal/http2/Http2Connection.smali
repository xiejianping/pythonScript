...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$h;,
        Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$Builder;,
        Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$g;
    }
.end annotation
...
.field final readerRunnable:Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$h;
...
.field final writer:Lorg/cocos2dx/okhttp3/internal/http2/c;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;
    ...
    invoke-static {v8, v1}, Lorg/cocos2dx/okhttp3/internal/Util;->threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
...
.method constructor <init>(Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iget-boolean v5, v1, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$Builder;->client:Z
    ...
    invoke-static {v6, v2}, Lorg/cocos2dx/okhttp3/internal/Util;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v2, v12}, Lorg/cocos2dx/okhttp3/internal/Util;->threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;

    move-result-object v2

    invoke-direct {v5, v4, v2}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    iput-object v5, v0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writerExecutor:Ljava/util/concurrent/ScheduledExecutorService;

    iget v2, v1, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$Builder;->pingIntervalMillis:I

    if-eqz v2, :cond_3

    new-instance v6, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$g;

    invoke-direct {v6, v0, v12, v12, v12}, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$g;-><init>(Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;ZII)V
    ...
    new-instance v2, Lorg/cocos2dx/okhttp3/internal/http2/c;
    ...
    invoke-direct {v2, v3, v4}, Lorg/cocos2dx/okhttp3/internal/http2/c;-><init>(Lorg/cocos2dx/okio/BufferedSink;Z)V

    iput-object v2, v0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writer:Lorg/cocos2dx/okhttp3/internal/http2/c;

    new-instance v2, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$h;

    new-instance v3, Lorg/cocos2dx/okhttp3/internal/http2/b;

    iget-object v1, v1, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$Builder;->source:Lorg/cocos2dx/okio/BufferedSource;

    iget-boolean v4, v0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v3, v1, v4}, Lorg/cocos2dx/okhttp3/internal/http2/b;-><init>(Lorg/cocos2dx/okio/BufferedSource;Z)V

    invoke-direct {v2, v0, v3}, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$h;-><init>(Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;Lorg/cocos2dx/okhttp3/internal/http2/b;)V

    iput-object v2, v0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->readerRunnable:Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$h;
...
.method private newStream(ILjava/util/List;Z)Lorg/cocos2dx/okhttp3/internal/http2/Http2Stream;
    ...
    iget-object v7, p0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writer:Lorg/cocos2dx/okhttp3/internal/http2/c;
    ...
    :try_start_2
    iget-object v0, p0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writer:Lorg/cocos2dx/okhttp3/internal/http2/c;

    invoke-virtual {v0, v6, v8, p1, p2}, Lorg/cocos2dx/okhttp3/internal/http2/c;->a(ZIILjava/util/List;)V
    ...
    invoke-virtual {v0, p1, v8, p2}, Lorg/cocos2dx/okhttp3/internal/http2/c;->a(IILjava/util/List;)V
    ...
    iget-object p1, p0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writer:Lorg/cocos2dx/okhttp3/internal/http2/c;

    invoke-virtual {p1}, Lorg/cocos2dx/okhttp3/internal/http2/c;->flush()V
...
.method close(Lorg/cocos2dx/okhttp3/internal/http2/ErrorCode;Lorg/cocos2dx/okhttp3/internal/http2/ErrorCode;)V
    ...
    :cond_2
    :try_start_3
    iget-object p2, p0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writer:Lorg/cocos2dx/okhttp3/internal/http2/c;

    invoke-virtual {p2}, Lorg/cocos2dx/okhttp3/internal/http2/c;->close()V
    :try_end_3
...
.method public flush()V
    ...
    invoke-virtual {v0}, Lorg/cocos2dx/okhttp3/internal/http2/c;->flush()V
...
.method pushDataLater(ILorg/cocos2dx/okio/BufferedSource;IZ)V
    ...
    new-instance p2, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$e;
    ...
    invoke-direct/range {v0 .. v7}, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$e;-><init>(Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILorg/cocos2dx/okio/Buffer;IZ)V
...
.method pushHeadersLater(ILjava/util/List;Z)V
    ...
    :try_start_0
    new-instance v7, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$d;
    ...
    invoke-direct/range {v0 .. v6}, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$d;-><init>(Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILjava/util/List;Z)V
...
.method pushRequestLater(ILjava/util/List;)V
    ...
    :try_start_1
    new-instance v0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$c;
    ...
    invoke-direct/range {v2 .. v7}, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$c;-><init>(Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILjava/util/List;)V
...
.method pushResetLater(ILorg/cocos2dx/okhttp3/internal/http2/ErrorCode;)V
    ...
    new-instance v6, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$f;
    ...
    invoke-direct/range {v0 .. v5}, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$f;-><init>(Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILorg/cocos2dx/okhttp3/internal/http2/ErrorCode;)V
...
.method public setSettings(Lorg/cocos2dx/okhttp3/internal/http2/Settings;)V
    ...
    :try_start_2
    iget-object v1, p0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writer:Lorg/cocos2dx/okhttp3/internal/http2/c;

    invoke-virtual {v1, p1}, Lorg/cocos2dx/okhttp3/internal/http2/c;->b(Lorg/cocos2dx/okhttp3/internal/http2/Settings;)V
...
.method public shutdown(Lorg/cocos2dx/okhttp3/internal/http2/ErrorCode;)V
    ...
    :try_start_4
    iget-object v2, p0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writer:Lorg/cocos2dx/okhttp3/internal/http2/c;

    sget-object v3, Lorg/cocos2dx/okhttp3/internal/Util;->EMPTY_BYTE_ARRAY:[B

    invoke-virtual {v2, v1, p1, v3}, Lorg/cocos2dx/okhttp3/internal/http2/c;->a(ILorg/cocos2dx/okhttp3/internal/http2/ErrorCode;[B)V
...
.method start(Z)V
    ...
    invoke-virtual {p1}, Lorg/cocos2dx/okhttp3/internal/http2/c;->b()V
    ...
    invoke-virtual {p1, v0}, Lorg/cocos2dx/okhttp3/internal/http2/c;->b(Lorg/cocos2dx/okhttp3/internal/http2/Settings;)V
    ...
    invoke-virtual {v1, v2, v3, v4}, Lorg/cocos2dx/okhttp3/internal/http2/c;->a(IJ)V

    :cond_0
    new-instance p1, Ljava/lang/Thread;

    iget-object v0, p0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->readerRunnable:Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$h;
...
.method public writeData(IZLorg/cocos2dx/okio/Buffer;J)V
    ...
    iget-object p4, p0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writer:Lorg/cocos2dx/okhttp3/internal/http2/c;

    invoke-virtual {p4, p2, p1, p3, v0}, Lorg/cocos2dx/okhttp3/internal/http2/c;->a(ZILorg/cocos2dx/okio/Buffer;I)V
    ...
    iget-object v3, p0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writer:Lorg/cocos2dx/okhttp3/internal/http2/c;

    invoke-virtual {v3}, Lorg/cocos2dx/okhttp3/internal/http2/c;->d()I
    ...
    iget-object v4, p0, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;->writer:Lorg/cocos2dx/okhttp3/internal/http2/c;
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v3}, Lorg/cocos2dx/okhttp3/internal/http2/c;->a(ZILorg/cocos2dx/okio/Buffer;I)V
...
.method writePing(ZII)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lorg/cocos2dx/okhttp3/internal/http2/c;->a(ZII)V
    :try_end_2
...
.method writeSynReply(IZLjava/util/List;)V
    ...
    invoke-virtual {v0, p2, p1, p3}, Lorg/cocos2dx/okhttp3/internal/http2/c;->b(ZILjava/util/List;)V
...
.method writeSynReset(ILorg/cocos2dx/okhttp3/internal/http2/ErrorCode;)V
    ...
    invoke-virtual {v0, p1, p2}, Lorg/cocos2dx/okhttp3/internal/http2/c;->a(ILorg/cocos2dx/okhttp3/internal/http2/ErrorCode;)V
...
.method writeSynResetLater(ILorg/cocos2dx/okhttp3/internal/http2/ErrorCode;)V
    ...
    new-instance v7, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$a;
    ...
    invoke-direct/range {v1 .. v6}, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$a;-><init>(Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILorg/cocos2dx/okhttp3/internal/http2/ErrorCode;)V
...
.method writeWindowUpdateLater(IJ)V
    ...
    new-instance v8, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$b;
    ...
    invoke-direct/range {v1 .. v7}, Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection$b;-><init>(Lorg/cocos2dx/okhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;IJ)V
